...
import { fetchGameById, fetchReviewsForGame, createReview } from '../api/api';
...
const GameDetail = () => {
    ...
    const handleReviewSubmit = async (reviewData) => {
        try {
            ...
            setReviewError('You have already reviewed this game or there was an error submitting your review.');
        }
    };
        ...
        <div className="game-detail-container">
            <div className="game-detail">
                <div className="game-header">
                    <img src={game.imageUrl} alt={game.name} className="game-detail-image" />
                    <div className="game-info">
                        ...
                        <div className="game-tags">
                            ...
                            {game.publisher && <span className="tag publisher">{game.publisher}</span>}
                        </div>
                    </div>
                </div>
                ...
                <div className="reviews-section">
                    ...
                    {user ? (
                        !userHasReviewed ? (
                            ...
                            <p className="already-reviewed">You have already reviewed this game.</p>
                        )
                    ) : (
